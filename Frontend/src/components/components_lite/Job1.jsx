...
const Job1 = ({ job }) => {
  ...
  return (
    <div className="p-5 rounded-md shadow-xl bg-slate-900 text-white border border-gray-100">
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" className="rounded-full text-black" size="icon">
          <Bookmark />
        </Button>
      </div>
